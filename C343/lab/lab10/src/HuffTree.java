...
public class HuffTree<Key, E> {
    ...
    private void buildCodeTable() {
        // Homework 04 Task B TODO: implement this method!
        //
        ...
        buildCodeTableHelp(root,"");

    }

    private void buildCodeTableHelp(BinNode<Integer, String> n, String a){
        if (n != null){
            if (n.getKey() == codeFreq.get(n.getValue())){
                codeTable.put(n.getValue(), a);
            }
            else {
                String b = a + 0;
                buildCodeTableHelp(n.getLeft(), b);
                b = a + 1;
                buildCodeTableHelp(n.getRight(), b);
            }
        }
    }
    ...
    public String decode(String inCode) {
        ...
        for (int i = 0; i < inCode.length(); i++) {
            if (inCode.substring(i, i + 1).equals("0")) {
                currentNode = currentNode.getLeft();
            }
            if (inCode.substring(i, i + 1).equals("1")) {
